...
# ==========================================
# 【新增】补全缺失的电商数据接口 (解决 404 报错)
# ==========================================

@__app.route('/get_products')
def get_products():
    # 返回空的商品列表，防止前端报错
    return jsonify([])

@__app.route('/get_all_marketing_products')
